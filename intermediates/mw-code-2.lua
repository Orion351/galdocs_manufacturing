...
for _, minisembler in pairs(MW_Data.MW_Minisembler) do -- put minisemblers in the appropriate tech unlock
  table.insert(
...
for _, tier in pairs(MW_Data.MW_Minisembler_Tier) do -- make the minisembler entities overall
  for minisembler, minisembler_data in pairs(MW_Data.minisembler_data) do
    local direction_set = {}
    local layer_set = {}
    ...
    local current_working_visualizations = layer_set
