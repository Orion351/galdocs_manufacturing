...
local pink_tint = { r = 0.75, g = 0.3,  b = 1,   a = 1.0 }    -- hex: c154ff = 0.7568627450980392, 0.32941176470588235, 1
local cyan_tint = { r = 0.3,  g = 0.6,  b = 0.8, a = 1.0 }    -- hex: 74BBDA = 0.4549019607843137, 0.7333333333333333, 0.8549019607843137
local gold_tint = { r = 1,  g =  0.9450980392156862, b = 0.5333333333333333, a = 1.0 }   -- hex: FFF188 = 1, 0.9450980392156862, 0.5333333333333333
local green_tint = { r = 0.0196078431372549, g =1, b = 0, a = 1.0 }  -- hex: 05FF00 = 0.0196078431372549, 1, 0
local orange_tint = { r = 1,  g = 0.4666666666666667, b = 0.011764705882352941, a = 1.0 } -- hex: FF7703 = 1, 0.4666666666666667, 0.011764705882352941
local purple_tint = { r = 0.4745098039215686,  g = 0, b = 1, a = 1.0 } -- hex: 7900FF = 0.4745098039215686, 0, 1
